...
1 & NA & nie & 0.84 & 0.88 & 0.61 \\ 
   \rowcolor[gray]{0.75}1 & NA & tak & 0.83 & 0.86 & 0.62 \\ 
  2 & 0 & nie & 0.82 & 0.89 & 0.60 \\ 
   \rowcolor[gray]{0.75}2 & 0 & tak & 0.82 & 0.87 & 0.62 \\ 
  2 & 1 & nie & 0.79 & 0.83 & 0.62 \\ 
   \rowcolor[gray]{0.75}2 & 1 & tak & 0.79 & 0.83 & 0.63 \\ 
  2 & 2 & nie & 0.76 & 0.80 & 0.57 \\ 
   \rowcolor[gray]{0.75}2 & 2 & tak & 0.76 & 0.80 & 0.59 \\ 
  2 & 3 & nie & 0.71 & 0.80 & 0.47 \\ 
   \rowcolor[gray]{0.75}2 & 3 & tak & 0.70 & 0.79 & 0.45 \\ 
  2 & 4 & nie & 0.49 & 0.83 & 0.19 \\ 
   \rowcolor[gray]{0.75}2 & 4 & tak & 0.48 & 0.82 & 0.20 \\ 
   \bottomrule
\end{tabular}
...
\begin{enumerate}
\item W oparciu o wyniki poprzedniej analizy zliczono następujace n-gramy: 1-gramy, 2-gramy (przerwy od 0 do 3) i 3-gramy (przerwy od 0 do 1). 
\item Wszystkie n-gramy (oprócz 1-gramów) zbinaryzowano. 
\item Metodą QuiPT wybrano $214$ z $25600$ potencjalnych n-gramów ($0.0083$). 
\item Wszystkie 1-gramy i wybrane 2 oraz 3-gramy użyto podczas 5-krotnej walidacji krzyżowej.
\end{enumerate}
